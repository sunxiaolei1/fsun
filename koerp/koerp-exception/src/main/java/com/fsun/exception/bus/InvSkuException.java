 ...
 * @date 2018年12月14日
 */
public class InvSkuException extends SCMException{
	...
	public InvSkuException(String errorMsg) {
        this(SCMErrorEnum.CUSTOMIZE_ERROR.getErrorCode(), errorMsg);
    }

    public InvSkuException(int errorCode, String errorMsg) {
    	super(errorCode, errorMsg, null);
    }
    
    public InvSkuException(SCMErrorEnum errorEnum) {
        super(errorEnum.getErrorCode(), errorEnum.getErrorMsg(), null);
    }
    
    public InvSkuException(SCMErrorEnum errorEnum, Throwable caused) {
