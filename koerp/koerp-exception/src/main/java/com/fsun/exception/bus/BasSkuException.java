 ...
 * @date 2018年12月9日
 */
public class BasSkuException extends SCMException{
	...
	public BasSkuException(String errorMsg) {
        this(SCMErrorEnum.CUSTOMIZE_ERROR.getErrorCode(), errorMsg);
    }

    public BasSkuException(int errorCode, String errorMsg) {
    	super(errorCode, errorMsg, null);
    }
    
    public BasSkuException(SCMErrorEnum errorEnum) {
        super(errorEnum.getErrorCode(), errorEnum.getErrorMsg(), null);
    }
    
    public BasSkuException(SCMErrorEnum errorEnum, Throwable caused) {
