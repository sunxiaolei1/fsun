 ...
 */
@Service
public class SkuUseSoReportService extends BaseReportService implements SkuUseSoReportApi {
	...
	public Map<String, Object> queryMap(SkuUseSoReportCondition condition) {
		...
		StringBuffer orderBy = new StringBuffer(" ORDER BY "+ ReportConditionFieldEnum.QUERY_DATE_TIME.getName() +" ASC ");
		...
		if(!StringUtils.isEmpty(sortColumn) && !StringUtils.isEmpty(sortType)){
			orderBy = new StringBuffer(" ORDER BY "+ sortColumn +" "+ sortType +" ");
		}
	...
	@Override
	public void queryCallInit(StringBuffer where, StringBuffer orderBy, ReportCondition condition,
