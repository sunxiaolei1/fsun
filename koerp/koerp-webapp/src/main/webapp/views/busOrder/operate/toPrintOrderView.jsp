...
<div id="printTableOrder" style="display:none;" >
	...
	<thead>
	  <TR>
	    ...
	    <TD width="8%">
	      <DIV align=center><b>优惠</b></DIV></TD>
	  </TR>	
	</thead>      
	  ...
	  <tfoot>
		  <tr>
		    <TD colspan="7" tdata="allSum" format="UpperMoney" align="left" tindex="9"><font>金额合计(大写)：###</font></TD> 
		    <TD colspan="2" tdata="allSum" format="#,##0.0" align="left" tindex="9"><font>小写金额 ￥###元</font></TD> 			   				  
		 </tr>
	  </tfoot>
	</TABLE>
</div>
...
function createOneOrderPage(LODOP,docOrderDto,currRow){
	...
	CreateTableOrderContext(docOrderDto.details,10,"tableOrderData");
	LODOP.SET_PRINT_STYLEA(0,"Vorient",3);
    var strStyle='<style type="text/css"> table,td,th {border-width: 1px;border-style: solid;border-collapse: collapse}</style>';
	LODOP.ADD_PRINT_TABLE(198,"1%","99%",180,strStyle + document.getElementById("printTableOrder").innerHTML);
		...
		while(j<=cellCount){		
			switch (j) {
			  ...
			  case 9: td = $("<td align='center'>"+ totalPrice +"</td>");				  				  
			    break;
			  case 10: td = $("<td align='center' >"+ couponPrice +"</td>");				  				  
			    break;
			  default: break;
			}
			td.appendTo(tr);
