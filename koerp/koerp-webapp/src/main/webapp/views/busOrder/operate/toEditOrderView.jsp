					...
					<form id="orderfm">
						...
						<table class="nb-formTable" style="width:100%;">
					        <tr>
					            <th width="12%">单据编号</th>
								<td>
									<input id="orderId" name="orderId" class="easyui-textbox" readOnly style="width:90%;" />
								</td>
								<th width="12%">单据类型</th>
								<td>
								...
								<th width="12%">所属店仓</th>
								<td>
									<input id="shopName" name="shopName" class="easyui-textbox" readOnly style="width:90%;" />							
								</td>
								<th width="12%">经办人</th>
								<td>
