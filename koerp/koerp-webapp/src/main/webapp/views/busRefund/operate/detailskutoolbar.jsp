...
<a href="#" id="addGoodsBtn" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="addSkuRow()">添加商品(或物料) </a>
...
function addSkuRow() {	
    ...
    $("<div></div>").dialog({
        ...
        closed: false,
        cache: false,
        href: "${api}/bus/basSku/toChooseEditSkuTreeGrid",
        view: {
            checkedSkus: currDetailData,
            currShopid: fromShopId,
            tradeType: '${orderType}'
        },
        modal: true,
        minimizable: false,
