...
<div id="printTableOrder" style="display:none;" >
	...
	<thead>
	  ...
	  <tfoot>
		  <tr>
		    <TD colspan="6" tdata="allSum" format="UpperMoney" align="left" tindex="9"><font>金额合计(大写)：###</font></TD> 
		    <TD colspan="3" tdata="allSum" format="#,##0.0" align="left" tindex="9"><font>小写金额 ￥###元</font></TD> 			   				  
		 </tr>
	  </tfoot>
	</TABLE>
</div>
...
function createOneOrderPage(LODOP,docOrderDto,currRow){
    ...
    var materiels = docOrderDto.materiels;
    if(materiels!=null && materiels.length>0){   	
    	$.each(materiels, function(){
    		details.push(this);
    	});
    }   
	CreateTableOrderContext(header, details,9,"tableOrderData");
...
{ 
	 ...
	 for(var i=0;i<list.length;i++)
	 {
		...
		var productType = formatter(obj.productType, parent.productType);
		...
		while(j<=cellCount){		
			switch (j) {
			  ...
			  case 3: td = $("<td align='center'>"+ goodsName +"</td>");
			    break;		  
			  case 4: td = $("<td align='center'>"+ productType +"</td>");
			    break;
			  case 5: td = $("<td align='center'>"+ property +"</td>");
			  	break;
			  case 6: td = $("<td align='center'>"+ qty +"</td>");
			    break;		    
			  case 7: td = $("<td align='center'>"+ unit +"</td>");
			  	break;
