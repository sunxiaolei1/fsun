				...
				<table class="nb-formTable" style="width:100%;">
			        ...
			        <tr>
						...
						<td>							
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<label for="tobuyerremark" >
								<input type="checkbox" id="tobuyerremark" name="tobuyerremark" style="zoom:140%;vertical-align:middle;" />
								<span style="color:red;">添加到买家留言,使智能审核,可以订单截停</span>
							</label>
	...
	$.ajax({
		...
		success : function(result) {	
			if(result.status){
				...
				$('#sysorderid', $remarkfm).val(header.sysorderid);											 		
				$('#originRemark', $remarkfm).textbox("setValue", header.sellerremark);				
			}else{
...
function getSaveData(){		
	...
	params.tobuyerremark = $("#tobuyerremark", $remarkfm).prop("checked")?1:0;
	var saveData = {
	     "params": params,
	     "saveUrl": "${api}/ecorder/operate/remark/update"
	}
	return saveData;
}
