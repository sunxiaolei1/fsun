		...
		<%@include file="../../../busCommon/commonSearchHeader.jsp"%>		
			<table style="width:100%;padding:5px;">
				<tr>									
					<td  width="6%">客户名称:</td>
					<td colspan="3">
						<input id="allCustomerCombo" name="customerCode"  class="easyui-combogrid" style="width:300px"/>
					</td>					
					<td  width="6%">交易门店:</td>
					<td>
				...
				<tr>	
					<td width="6%">关键字:</td>
					<td colspan="3">
						<input name="keywords" id="keywords" data-options="prompt:'输入销售单号、客户名称、手机号...'" class="easyui-textbox" style="width:300px" />
					</td>																																											
					<td width="6%">单据日期:</td>
					<td colspan="3">
