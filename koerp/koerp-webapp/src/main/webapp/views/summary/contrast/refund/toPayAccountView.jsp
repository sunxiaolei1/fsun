...
<div class="easyui-layout" style="width:100%;height:100%;">
	<div title="单据编号: ${param.refundId}, 客户名称: ${param.buyerName}, 交易门店: ${param.shopName}" data-options="region:'center',split:true,collapsible:false" style="padding:5px">	
...
$(function() {
	...
	$.ajax({
		type : "GET",
		url : "${api}/summary/contrast/refund/payAccount/list?refundId=${param.refundId}",   
		dataType : "json",
