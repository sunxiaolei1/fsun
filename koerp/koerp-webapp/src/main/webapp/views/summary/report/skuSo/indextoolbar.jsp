...
function exportExcel(type){
	...
	var url = "${api}/summary/report/sku/so/exportExcel?";
	if(type=='0'){
		url = "${api}/summary/report/sku/details/so/all/exportExcel?";
	}
...
function toDetailView(rowData){
	...
	var queryParams = initQueryParams();
	var url = "${api}/summary/report/sku/so/toDetailView?sku="+ currRow.sku
