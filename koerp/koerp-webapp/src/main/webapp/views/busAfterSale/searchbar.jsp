		...
		<%@include file="../busCommon/commonSearchHeader.jsp"%>
			<table style="width: 100%;padding:5px;">
				<tr>
					<td width="8%">关键字:</td>
					<td>
						<input id="q" name="q" data-options="prompt:'输入退货单号、原订单号...'" class="easyui-textbox" style="width:85%;" />
					</td>								
					<td width="8%">换发单号:</td>
					<td>
						<input id="barterOrderId" name="barterOrderId"  class="easyui-textbox" style="width:80%;" />
					</td>
					<td width="8%">单据类型:</td>
					<td>	
