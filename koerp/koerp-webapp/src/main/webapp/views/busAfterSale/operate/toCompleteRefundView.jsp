...
<div class="easyui-layout" fit=true style="height:100%;">		
	<div data-options="region:'center',split:true" style="border: 0px solid #ccc;" >		
		<h1 style="font-size:14px;text-align:center;margin:15px 0px 10px 0px;">此操作将进行退货完成处理,请确认是否继续?</h1>								
	...
	<div data-options="region:'south'" class="operate-toolbar">
	    <div style="float:right;margin-right:10px;">
	    	<a href="#" class="easyui-linkbutton" iconCls="icon-disk" plain="false" onclick="completeRefund()">确认</a>
...
function getSaveData(){		
	...
	var saveData = {
	     "params": params,
	     "saveUrl": "${api}/ecaftersale/refund/completeRefund"
	}
	return saveData;
}
