...
<div id="tools" style="display: none;">
	...
	<shiro:hasPermission name="orders:cancelOrder">  
	...
	<shiro:hasPermission name="orders:query">  
		<a href="#" class="easyui-linkbutton" iconCls="icon-cog_go" plain="true" onclick="">审核通过</a>
	</shiro:hasPermission>	
	<shiro:hasPermission name="orders:query">  
		<a href="#" class="easyui-linkbutton" iconCls="icon-award_star_silver_3" plain="true" onclick="">处理标记</a>
	</shiro:hasPermission>
	<shiro:hasPermission name="orders:query">  
		<a href="#" class="easyui-linkbutton" iconCls="icon-arrow_undo" plain="true" onclick="">转为普通订单</a>
	</shiro:hasPermission>
