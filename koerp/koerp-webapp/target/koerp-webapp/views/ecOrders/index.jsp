...
$(function() {
	...
	currDataGrid.datagrid({
	    ...
	    onLoadSuccess:function(data){	    
	    	buttonsEnabledValidator($(this), ["order_detail_view", "order_reaudit"], ListModuleType.ORDER_BASE);	    		    	
	    },
...
function view(){
	...
	if (row) {
		$("<div></div>").dialog({
		    ...
		    closed:false,
		    cache:false,
		    href:"${api}/ecorder/toDetail/" + row.sysorderid +"?buttontype=baseos",	   
		    modal:true,
...
<div class="easyui-layout" style="width:100%;height:100%;">
	<div title="销售单管理" data-options="region:'center',split:true,collapsible:false" style="padding:5px">
		...
		<!-- table -->
		<div id="gridDiv" data-options="region:'center'" style="height: 63%">
...
<div id="tools" style="display: none;">
	...
	<shiro:hasPermission name="orders:query">  
		<a href="#" class="easyui-linkbutton" iconCls="icon-mouse_add" plain="true" onclick="toOneKeyRefundView()">一键退货</a>
	</shiro:hasPermission>	
	<shiro:hasPermission name="orders:query">  
		<a href="#" id="order_reaudit" class="easyui-linkbutton" iconCls="icon-asterisk_red" plain="true" onclick="">重新审核</a>
	</shiro:hasPermission>		
