...
<div class="easyui-layout" style="width:100%;height:100%;">
	<div title="退款单管理" data-options="region:'center',split:true,collapsible:false" style="padding:5px">
		<!-- 查询条件 -->
...
<div id="tools" style="display: none;">
	...
	<a href="#" class="easyui-linkbutton" iconCls="icon-printer" plain="true" onclick="">打印</a>
	<a href="#" class="easyui-linkbutton" iconCls="icon-arrow_undo" plain="true" onclick="">回退</a>	
	<a href="#" class="easyui-linkbutton" iconCls="icon-page_white_excel" plain="true" onclick="exportExcel()">导出</a>
	<a href="#" class="easyui-linkbutton" iconCls="icon-award_star_silver_3" plain="true" onclick="">完成退款</a>	
	<a href="#" class="easyui-linkbutton" iconCls="icon-arrow_refresh" plain="true" onclick="reflushDataGrid()">刷新</a>		
	<a href="#" class="easyui-linkbutton" iconCls="icon-asterisk_red" plain="true" onclick="">退款异常</a>
	<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="">添加备注</a>
	<a href="#" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" onclick="">拒绝退款</a>
	<a href="#" class="easyui-linkbutton" iconCls="icon-award_star_gold_1" plain="true" onclick="">允许退款</a>
...
var frozenColumns = 
	[[
		...
		{field:'cashid',title:'退款单号',width:230, align:"center",sortable:true},
...
var columns = 
    [[
		...
		{field:"refundcashstatus",title:"退款状态",width:80,align:'center',sortable:true,formatter:function(value, row){
		...
		{field:"refundprice",title:"应退金额",width:80,align:'center',sortable:true,formatter:numBaseFormat},
		{field:"integralamount",title:"积分",width:80,align:'center',sortable:true,formatter:numBaseFormat},
		{field:"refundreason",title:"退款原因",width:100,align:'center',sortable:true,formatter:function(value, row){
			return formatter(value, window.parent.ecRefundreason);
		}},
		{field:"remark",title:"备注",align:'center',sortable:true, width:180},
		{field:"returnmode",title:"退款方式",width:80,align:'center',sortable:true,formatter:function(value, row){
			return formatter(value, window.parent.ecReturnmode);
		}},
		{field:"bankaccount",title:"退款账户",align:'center',sortable:true, width:140},
...
function view(){
	...
	if (row) {
		...
		$.messager.alert("提示","请选择一行要编辑的退款单！");
	}
