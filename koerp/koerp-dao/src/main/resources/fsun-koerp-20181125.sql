...
CREATE TABLE `bus_goods` (
  ...
  `brand_code` varchar(32) DEFAULT NULL COMMENT '品牌编码',
  `product_type` smallint(6) NOT NULL COMMENT '产品类型 1 单品，2 组合',
...
CREATE TABLE `bus_order` (
  ...
  `logistics_plat` varchar(64) DEFAULT NULL COMMENT '配送平台名称',
  `logistics_type` smallint(6) DEFAULT NULL COMMENT '配送平台类型[1平台配送；0自配送]',
  `logistics` varchar(64) DEFAULT NULL COMMENT '配送人员姓名',
  `logistics_phone` varchar(32) DEFAULT NULL COMMENT '配送人员联系方式',
  `settle_time` datetime DEFAULT NULL COMMENT '日结时间',
  `logistics_time` datetime DEFAULT NULL COMMENT '配送下达时间',
  `logistics_pick_time` datetime DEFAULT NULL COMMENT '配送取餐时间',
  `logistics_receive_time` datetime DEFAULT NULL COMMENT '配送送达时间',
...
CREATE TABLE `doc_asn_details` (
  ...
  `convert_qty` decimal(18,2) DEFAULT NULL COMMENT '换算数量',
  `convert_unit` varchar(32) DEFAULT NULL COMMENT '换算单位',
  `total_price` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '商品总金额',
  `cost_price` decimal(18,2) DEFAULT '0.00' COMMENT '成本价',
  `lot_num` varchar(32) DEFAULT '0' COMMENT '批次号',
