 ...
 * @date 2019年2月12日
 */
public class BusRefundCondition extends BaseOrderCondition{
	...
	public String getRefundIdsStr() {
		return refundIdsStr;
	}

	public void setRefundIdsStr(String refundIdsStr) {
		this.refundIdsStr = refundIdsStr;
		if(refundIdsStr!=null && !"".equals(refundIdsStr)){
			this.refundIds = refundIdsStr.split(",");
		}
	}
