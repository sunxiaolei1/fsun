...
public class BusGoods {
    /**
     * goods_id
     * 表字段 : bus_goods.goods_id
     */
    private String goodsId;

    /**
     * 订单id
     * 表字段 : bus_goods.order_id
     */
    private String orderId;

    /**
     * 行号
     * 表字段 : bus_goods.line_no
     */
    ...
    /**
     * 品牌编码
     * 表字段 : bus_goods.brand_code
     */
    private String brandCode;

    /**
     * 产品类型 1 单品，2 组合
     * 表字段 : bus_goods.product_type
     */
    private Short productType;

    /**
     * 商品名称
     * 表字段 : bus_goods.goods_name
     */
    private String goodsName;

    /**
     * 商品条码
     * 表字段 : bus_goods.bar_code
     */
    ...
    /**
     * parent_sku
     * 表字段 : bus_goods.parent_sku
     */
    private String parentSku;

    /**
     * 原SKU ID
     * 表字段 : bus_goods.sku_id
     */
    private String skuId;

    /**
     * 原父SKU ID
     * 表字段 : bus_goods.parent_sku_id
     */
    private String parentSkuId;

    /**
     * 英文单位简称
     * 表字段 : bus_goods.en_unit
     */
    private String enUnit;

    /**
     * 总分摊价
     * 表字段 : bus_goods.total_part_price
     */
    private BigDecimal totalPartPrice;

    /**
     * 税种
     * 表字段 : bus_goods.rate_type
     */
    ...
    /**
     * 换算数量
     * 表字段 : bus_goods.convert_qty
     */
    private BigDecimal convertQty;

    /**
     * 换算单位
     * 表字段 : bus_goods.convert_unit
     */
    private String convertUnit;

    /**
     * 市场价
     * 表字段 : bus_goods.market_price
     */
    private BigDecimal marketPrice;

    /**
     * 原销售价
     * 表字段 : bus_goods.origin_sale_price
     */
    private BigDecimal originSalePrice;

    /**
     * 实际销售价(销售价、会员价)
     * 表字段 : bus_goods.sale_price
     */
    ...
    /**
     * 商品折价 销售价-分摊价=折扣价
     * 表字段 : bus_goods.discount_price
     */
    private BigDecimal discountPrice;

    /**
     * 商品销售总金额
     * 表字段 : bus_goods.total_price
     */
    private BigDecimal totalPrice;

    /**
     * 成本价
     * 表字段 : bus_goods.cost_price
     */
    private BigDecimal costPrice;

    /**
     * 税率
     * 表字段 : bus_goods.rate_precent
     */
    private BigDecimal ratePrecent;

    /**
     * 是否为赠品 1 赠品，0 非赠品
     * 表字段 : bus_goods.is_gift
     */
    private Boolean isGift;

    /**
     * 赠送数量
     * 表字段 : bus_goods.gift_count
     */
    private BigDecimal giftCount;

    /**
     * 赠送金额
     * 表字段 : bus_goods.gift_price
     */
    private BigDecimal giftPrice;

    /**
     * 点单界面是否显示，不显示用于组合商品
     * 表字段 : bus_goods.is_show
     */
    private Boolean isShow;

    /**
     * 商品属性
     * 表字段 : bus_goods.property
     */
